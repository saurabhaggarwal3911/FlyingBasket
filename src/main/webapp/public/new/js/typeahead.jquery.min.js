        ...
        k = function() {
            ...
            return b.mixin(c.prototype, {
                ...
                _onEnterKeyed: function(a, b) {
                    var c;
                    (c = this.menu.getActiveSelectable()) && this.select(c) && (b.preventDefault(), b.stopPropagation())
                },
                ...
                select: function(a) {
                    ...
                    if(elementExist($("#auditSectionName"))){
                    	$("#auditSectionName").val(b.val);
                    changeSectionInfo();
                    }
                ...
                autocomplete: function(a) {
                    var b, c, d;
                    return b = this.input.getQuery(), c = this.menu.getSelectableData(a), d = c && b !== c.val, !(!d || this.eventBus.before("autocomplete", c.obj, c.dataset)) && (this.input.setQuery(c.val), this.eventBus.trigger("autocomplete", c.obj, c.dataset), !0)
                },

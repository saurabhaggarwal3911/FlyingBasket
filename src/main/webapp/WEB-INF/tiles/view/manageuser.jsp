  ...
  setInnerBodyHeight();
                      	...
                      	<c:forEach items="${userList}" var="userListVar" varStatus="userListVarStatus">
                           <div class="grid-row">
                             <div class="row m-0">
                               ...
                               <div class="col-xs-4 ">${userListVar.email}</div>
	...
	<div style="text-align: center" class="paging-links">
		<a id="lnkFirst" class="float_left" href="javascript:firstPage();"><i
			...
			class="CustPageLabelClass">of 1<%-- ${totalPages} --%></label> <a id="lnkNext"
		...
		function addUserPopup(){
		 ...
		 function addUserSubmit(){
			 ...
			 var success = true;
			  ...
			  else if(isFieldBlank("adduserform_mobile", '<spring:message code="NotBlank.userDto.mobile"/>')){
				  success = false;

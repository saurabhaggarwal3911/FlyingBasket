	...
	<!-- ---------- -->
      ...
      <div class="card p-b-0 m-b-10 bg-hide ">
        ...
        <%--   <c:set scope="page" var="noneditable" value="${userDto.adUser}"></c:set> --%>
            ...
            <c:set var="usernameHasBindError"><form:errors path="username"/></c:set>
...
<c:choose>
                                ...
                                <div class="form-group ${not empty usernameHasBindError? 'has-error' : ''}">
                                    <label class="col-sm-3 control-label" for="useremailField">Username</label>
                                    <div class="col-sm-8">
                                        
                                        <div class="fg-line">
                                        <c:choose>
			                               <c:when test="${userInEditMode}">
                                            <form:input type="email" path="username" id="userenameField" class="form-control input-sm "></form:input>
			                              ...
			                              <c:otherwise>
			                              <form:input type="email" path="username" id="userenameField" readonly="true" class="form-control input-sm r-only" ></form:input>
                                        ...
                                        <form:errors path="username" class="help-block  has-error" element="small"/>
                                    </div>
                                </div>

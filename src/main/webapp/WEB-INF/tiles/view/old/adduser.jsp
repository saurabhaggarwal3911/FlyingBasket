...
<%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
      ...
      <c:if test="${error != null}">
		...
		<div class="row">
         <div class="col-xs-12 ${not empty usernameHasBindError? 'has-error' : ''}">
            <div class="fg-line">
            	<form:input path="username" class="form-control m-t-0" placeholder="User Name" id="adduserform_username"/>
            </div>
            <form:errors path="username" class="help-block" element="small"/>
          </div>
        ...
        <div class="row">
         ...
         <div class="col-xs-6 m-t-15">
            <div class="fg-line">
            	<label class="fg-label">Role <span class="pre-field-cont">ORGANIZATION ADMIN</span></label>
            </div>
          </div>

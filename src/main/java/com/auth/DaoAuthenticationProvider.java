...
public class DaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
   ...
   * {@link PasswordEncoder#isPasswordValid(String, String, Object)} on when the user is not found
   * to avoid SEC-2056.
   */
  ...
  /**
   * The password used to perform {@link PasswordEncoder#isPasswordValid(String, String, Object)} on
   * when the user is not found to avoid SEC-2056. This is necessary, because some
   * {@link PasswordEncoder} implementations will short circuit if the password is not in a valid
   * format.
   */
   ...
   * password will be compared as plain text.
   * <p>
   * For systems which are already using salted password which are encoded with a previous release,
   * the encoder should be of type
